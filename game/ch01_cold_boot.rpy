...
label ch01_cold_boot:
    ...
    "Bardzo chcesz do niego podejść bliżej i mu się przyjrzeć, ale...{w=.5} bardzo się go boisz..."
    ...
    with vpnuch
    p "SHUT UP"
    "Piotr's serious tone finally gets to you and you finally take in the weight of the situation"
    you "Okay okay calm down"
    "You instinctively try to push yourself away from him, which is impossible because of the tree behind you"
    "Maybe you {i}should{/i} be scared of him"
    p "Thank you"
    p "Now get off the dirt you look like a mess"
    "Piotr gives you a helping hand, but right you are too scared of him to touch him or his claws"
    p "What?"
    p "I don't bite"
    # https://en.wikipedia.org/wiki/Temperate_broadleaf_and_mixed_forests
    "You reluctantly take his hand and get off the floor, taking time to clean your dirty ass"
    "When you get up a gentle breeze sweeps through the forest, making you shiver a little"
    "Piotr examins you carefully while you are examining the forest, almost as if looking for an escape route"
    ...
    "And finally, you notice the forest floor covered in browned birch leaves and pine needles from the coniferous tree behind you"
    "Amongst those leaves there are countless shrubs, stones, bugs and plants unknown to you"
    ...
    "His backpack was on the ground, tucked away behind a bush in front of a ... ritual??"
    you "{i}What is that{/i}"
    you "{i}Oh my god what if he DID summon me{/i}"
    you "{i}I don't know where to run though{/i}"
    ...
    p "To jest onyks. Używam tych kamieni do usuwania złej energii z tego lasu."
    you "Oh"
    p "Do you want to know why i want you to stay quiet?"
    you "Well yes"
    p "There are these mutated wolves everywhere and if they hear you you are DONE"
    "Hearing this something in you clicks, and you realized how foolish you were just half a minute ago"
    you "You should have told me this earlier"
    you "Maybe then i wouldnt have been so loud"
    ...
    p "If a stone is too dirty i just leave it at home"
    ...
    p "Yes"
    you "What if i am evil and your little ritual kills me"
...
label ch01_piotrIntroductionMenu:
    menu:
        "Kim ty jesteś" if not flag("askedWhoPiotrWas"):
            ...
            p "Who are you"
            you "Oh... about that.."
            "You are trying to remember facts about but you cannot come up with anything"
            "Something is clearly wrong - there's no way you just spawned in like a video game NPC with all your knowledge"
            ...
            "Piotr shakes his head, already annoyed"
        ...
        "Zapytaj się gdzie jesteś" if not flag("askedWhereIAmStart"):
            ...
            "Theres a huge wall about a hundred behind you and you can only assume it guards a city"
...
label ch01_afterPiotrIntroductionMenu:
    "Patrzysz się dookoła i widzisz tylko drzewa, a z sto metrów dalej jest ogromny mur. Taki ogromny, że mógłby to być Wielki Mur Chiński - ale wyglądał na za bardzo z Temu, żeby był oryginalny."
    ...
    "Razem z Piotrem wracacie przez most i podążacie do urzędu miasta. Pomimo późnej godziny temperatura nie jest niesprzyjająca, nawet przyjemna."
    ...
    p "No przecież mówiłem! Wchodzimy teraz do miasta Bratgren."
    ...
    you "Dlaczego prawie nikogo nie ma na ulicach?"
    ...
    "Na ulicach nie ma prawie nikogo{w}, oprócz {i}was{/i}."
    ...
    "Ten budynek miał taką...{w=0.5} urzędniczą aurę."
    scene bg cityhallinside with dissolve
