...
label ch01_cold_boot:
    ...
    call chapterTransition("Akt 1", "So what now?") from _call_chapterTransition
...
label ch01_piotrIntroductionMenu:
    menu:
        "Who are you?" if not flag("askedWhoPiotrWas"):
            ...
            you "{i}Oh my god.{/i}"
            p "I'm also a doctor."
            p "I treat residents and help them in all sorts of situations related to their poor physical {b}AS WELL AS MENTAL{/b} health."
            you "Thats so cute!"
...
label ch01_afterPiotrRagebaitMenu:
    ...
    f "She likes explaining this stuff, you just have to be nice to her."
    f "Just don't stress about it. Be nice to her and she'll be nice to you."
    you "{i}TFYM DON'T STRESS ABOUT IT?{/i}"
    ...
    k "Everyone has memory loss like you do."
    you "So we all this amnesia disease?"
    k "Not quite."
    you "How?"
    k "Answer this question: What's your favorite food?"
    k "Or, even better, what's your opinion on potatoes?"
    menu:
        "I LOVE potatoes":
            "Barbara seems very pleased."
        "I HATE potatoes":
            "Barbara eyes you top to bottom, trying to get a grip of who the hell are you."
    k "The fact that you can answer this means this isn't amnesia."
    you "Oh."
...
label ch01_firstNightTownWalkPartB:
    ...
    wp "What happened to your attitude? You weren't rude to me."
    you "I am now at peace."
    ...
    wp "Like 8?"
    you "Ohh so you are a local at this point, that's so cool."
    you "You must know alot about Bratgren."
    wp "Yeah I guess you could say so."
    you "Could you tell me something about this city?"
    you "For starters, where IS this Bratgren?"
    you "Like I know I am IN Bratgren but where are we?"
