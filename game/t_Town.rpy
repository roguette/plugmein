...
label t_GoingToTheLibrary:
    ...
    you "Podnieś to"
    "Rafał i Barosz biorą książkę i podnoszą ją, a ty bierzesz stronę i patrzysz na nią pod światło, próbując przeczytać nazwisko właściciela." 
