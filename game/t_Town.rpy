...
label t_gotMoneyBakeryTea:
    ...
    r "I teraz uwaga."
    r "Słyszałem, jak jakaś pani kłociła się ze swoim mężem."
    wp "CO..."
    r "Tak się darli, że to szok"
    wp "Co ta żona mówiła"
    r "No dobra cicho wrócę do tego"
    r "Okazuje się, że ten mąż jej zdradził"
    ...
    r "Ta żona jest siostrą babci brata kuzynki siostry mojej koleżanki z pracy"
    you "No..."
    you "To jest trochę szalone"
    you "Że takie rzeczy się dzieją w tym mieście"
    ...
    wp "Muszę zapytać."
    "Wiktoria pochyla się JESZCZE bliżej ciebie"
